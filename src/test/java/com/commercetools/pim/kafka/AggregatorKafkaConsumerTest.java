...
@SpringBootTest
public class AggregatorKafkaConsumerTest extends AggregatorCommonSetUpClass{
	...
	public void testDumpDataForCreation() throws AggregatorException {
		when(aggregatorProductDaoObjectRepository.findRecord(anyString(),anyString())).thenReturn(new ArrayList<>());
		...
		aggregatorKafkaConsumer.processMessage("{"
				+ "\"provider\":\"provider1\","
				+ "\"requestTimeStampInMS\":1567242403906,"
				+ "\"name\":\"Name1\","
				+ "\"available\":true,"
	...
	@Test
	public void testDumpDataForUpdate() throws AggregatorException {
	...
	public void testDumpEmptyData() throws AggregatorException {
		aggregatorKafkaConsumer.processMessage("");
	}
}
